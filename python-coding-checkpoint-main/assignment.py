...
whole_number = int(67)
decimal_number = float(4.87)
message = str("God is good")
answer = bool(True)
...
# from number_one.
difference = int(number_two - number_one)
...
price = (14)
quantity = (7)
purchase_total = int(price * quantity)
...
starting_balance = (850)
amount_spent = (237)
remaining_balance = int(starting_balance - amount_spent)
...
boxes = (12)
items_per_box = (24) 
total_items = int (boxes * items_per_box)
...
hourly_pay = (20)
hours_worked = (8)
daily_pay = int(hourly_pay * hours_worked)
...
first_name = str("Adrian")
last_name = str("Esquivel")
...
# into course_name.
word_one = str("Python")
word_two = str("Programming")
course_name = str(word_one + " " + word_two)
...
print (user_name + " likes to eat " + favorite_food)
...
user_sum = int(first_user_number + second_user_number)
user_difference = int(first_user_number - second_user_number)
user_product = int(first_user_number * second_user_number)
user_quotient = int(first_user_number / second_user_number)
# TASK 39:
...
one_day_pay = float(work_hours * hourly_rate)   
...
five_day_pay = float(one_day_pay * 5)
...
money_after_spending = float(five_day_pay - money_spent)
...
total_cost = float(360)
number_of_items = int(12)
cost_per_item = float(total_cost / number_of_items)
...
# each hour.
total_distance = float(450)
hours = int(6)
distance_per_hour = float(total_distance / hours)
...
classrooms = int(5)
students_per_classroom = int(total_students / classrooms)
...
item_price = float(18)
number_purchased = int(5)
subtotal = float(item_price * number_purchased)
...
shipping_cost = float(12)
total_with_shipping = float(subtotal + shipping_cost)
...
amount_paid = float(150)
change_received = float(amount_paid - total_with_shipping)
...
approximate_age = int(current_year - birth_year)
...
age_message = str("You are approximately " + age_as_string + " years old.")
...
number3 = int(input("Enter a third whole number: "))
combined_total = int(number1 + number2 + number3)
...
#
# in this calculation.
final_answer = int(doubled_average - number1)
...
result = favorite_number * approximate_age
print("Hello, " + full_name + "!")
print("You are approximately " + str(approximate_age) + " years old.")
print("The result of your favorite number multiplied by your age is: " + str(result))
